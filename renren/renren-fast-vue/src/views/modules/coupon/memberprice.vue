<template>
    <div class="mod-config">
        ...
        >
            ...
            ></el-table-column>
            <el-table-column align="center" header-align="center" label="会员对应价格" prop="memberPrice"></el-table-column>
            <el-table-column align="center" header-align="center" label="可否叠加其他优惠" prop="addOther">
