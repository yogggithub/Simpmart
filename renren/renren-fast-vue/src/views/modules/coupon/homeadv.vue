<template>
    <div class="mod-config">
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="名字" prop="name"></el-table-column>
            <el-table-column align="center" header-align="center" label="图片地址" prop="pic"></el-table-column>
            ...
            <el-table-column align="center" header-align="center" label="状态" prop="status"></el-table-column>
            <el-table-column align="center" header-align="center" label="点击数" prop="clickCount"></el-table-column>
            <el-table-column align="center" header-align="center" label="广告详情连接地址" prop="url"></el-table-column>
            ...
            <el-table-column align="center" header-align="center" label="发布者" prop="publisherId"></el-table-column>
            <el-table-column align="center" header-align="center" label="审核者" prop="authId"></el-table-column>
            <el-table-column
                align="center"
                fixed="right"
                header-align="center"
