    ...
    >
        ...
        >
            <el-form-item label="优惠卷类型" prop="couponType">
                <el-select placeholder="请选择" v-model="dataForm.couponType">
            ...
            <el-form-item label="优惠卷名字" prop="couponName">
                <el-input placeholder="优惠卷名字" v-model="dataForm.couponName"></el-input>
            </el-form-item>
            <el-form-item label="数量" prop="num">
                <el-input-number :min="0" v-model="dataForm.num"></el-input-number>
            </el-form-item>
            <el-form-item label="金额" prop="amount">
                <el-input-number :min="0" :precision="2" v-model="dataForm.amount"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label="使用类型" prop="useType">
                <el-select placeholder="请选择" v-model="dataForm.useType">
            ...
            <el-form-item label="发行数量" prop="publishCount">
                <el-input-number :min="0" v-model="dataForm.publishCount"></el-input-number>
            </el-form-item>
            ...
            <el-form-item label="优惠码" prop="code">
                <el-input placeholder="优惠码" v-model="dataForm.code"></el-input>
            </el-form-item>
            <el-form-item label="领取所需等级" prop="memberLevel">
                <el-select placeholder="请选择" v-model="dataForm.memberLevel">
