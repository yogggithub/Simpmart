<template>
    <div class="mod-config">
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="专题名字" prop="name"></el-table-column>
            <el-table-column align="center" header-align="center" label="专题标题" prop="title"></el-table-column>
            <el-table-column align="center" header-align="center" label="专题副标题" prop="subTitle"></el-table-column>
            <el-table-column align="center" header-align="center" label="显示状态" prop="status"></el-table-column>
            <el-table-column align="center" header-align="center" label="详情连接" prop="url"></el-table-column>
            <el-table-column align="center" header-align="center" label="排序" prop="sort"></el-table-column>
            <el-table-column align="center" header-align="center" label="专题图片地址" prop="img"></el-table-column>
            <el-table-column
                align="center"
                fixed="right"
                header-align="center"
