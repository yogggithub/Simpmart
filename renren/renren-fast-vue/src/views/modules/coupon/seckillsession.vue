    ...
    <div class="mod-config">
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <el-button @click="relationProduct(scope.row.id)" size="small" type="text">关联商品</el-button>
        ...
        <div>
            <el-dialog
                ...
                width="60%"
            >
                <seckillsku-relation :sessionId="currentId" ref="seckillskuRelation"></seckillsku-relation>
            </el-dialog>
        </div>
    </div>
</template>
