<template>
    <div class="mod-config">
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="活动场次id" prop="sessionId"></el-table-column>
            <el-table-column align="center" header-align="center" label="订阅时间" prop="subcribeTime"></el-table-column>
            <el-table-column align="center" header-align="center" label="发送时间" prop="sendTime"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
