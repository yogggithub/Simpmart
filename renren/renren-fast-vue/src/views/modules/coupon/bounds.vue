<template>
    <div class="mod-config">
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label prop="spuId"></el-table-column>
            <el-table-column align="center" header-align="center" label="成长积分" prop="growBounds"></el-table-column>
            <el-table-column align="center" header-align="center" label="购物积分" prop="buyBounds"></el-table-column>
            <el-table-column align="center" header-align="center" label="优惠生效情况" prop="work">
