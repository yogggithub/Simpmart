<template>
    <div class="mod-config">
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="spu_id" prop="skuId"></el-table-column>
            <el-table-column align="center" header-align="center" label="满几件" prop="fullCount"></el-table-column>
            <el-table-column align="center" header-align="center" label="打几折" prop="discount"></el-table-column>
            <el-table-column align="center" header-align="center" label="折后价" prop="price"></el-table-column>
            <el-table-column align="center" header-align="center" label="是否叠加优惠" prop="addOther"></el-table-column>
            <el-table-column
                align="center"
                fixed="right"
                header-align="center"
