<template>
    <div class="mod-config">
        ...
        >
            ...
            ></el-table-column>
            <el-table-column align="center" header-align="center" label="商品id" prop="skuId"></el-table-column>
            <el-table-column align="center" header-align="center" label="秒杀价格" prop="seckillPrice"></el-table-column>
            <el-table-column align="center" header-align="center" label="秒杀总量" prop="seckillCount"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="每人限购数量"
                prop="seckillLimit"
            ></el-table-column>
            <el-table-column align="center" header-align="center" label="排序" prop="seckillSort"></el-table-column>
            <el-table-column
                align="center"
                fixed="right"
                header-align="center"
