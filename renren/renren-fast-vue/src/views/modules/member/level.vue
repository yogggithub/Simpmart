<template>
    <div class="mod-config">
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="等级名称" prop="name"></el-table-column>
            <el-table-column align="center" header-align="center" label="所需成长值" prop="growthPoint"></el-table-column>
            <el-table-column align="center" header-align="center" label="默认等级" prop="defaultStatus">
