    ...
    >
        ...
        >
            ...
            <el-form-item label="所需成长值" prop="growthPoint">
                <el-input-number :min="0" v-model="dataForm.growthPoint"></el-input-number>
            </el-form-item>
            <el-form-item label="默认等级" prop="defaultStatus">
                <el-checkbox :false-label="0" :true-label="1" v-model="dataForm.defaultStatus"></el-checkbox>
            </el-form-item>
            ...
            <el-form-item label="是否有生日特权" prop="priviledgeBirthday">
                <el-checkbox :false-label="0" :true-label="1" v-model="dataForm.priviledgeBirthday"></el-checkbox>
            </el-form-item>
