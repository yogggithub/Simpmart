<template>
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button
                    ...
                    type="primary"
                    v-if="isAuth('commodity:categorybrandrelation:save')"
                >Add</el-button>
                <el-button
                    :disabled="dataListSelections.length <= 0"
                    @click="deleteHandle()"
                    type="danger"
                    v-if="isAuth('commodity:categorybrandrelation:delete')"
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label prop="id"></el-table-column>
            ...
            <el-table-column
                ...
                prop="catelogId"
            ></el-table-column>
            <el-table-column align="center" header-align="center" label prop="brandName"></el-table-column>
            <el-table-column align="center" header-align="center" label prop="catelogName"></el-table-column>
            <el-table-column
                align="center"
                fixed="right"
                header-align="center"
