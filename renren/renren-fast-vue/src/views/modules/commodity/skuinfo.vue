    ...
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button
                    ...
                    type="primary"
                    v-if="isAuth('commodity:skuinfo:save')"
                >Add</el-button>
                <el-button
                    :disabled="dataListSelections.length <= 0"
                    @click="deleteHandle()"
                    type="danger"
                    v-if="isAuth('commodity:skuinfo:delete')"
        ...
        >
            ...
            <el-table-column
                ...
                prop="skuDefaultImg"
            ></el-table-column>
            <el-table-column align="center" header-align="center" label="sku title" prop="skuTitle"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="sku sub title"
                prop="skuSubtitle"
            ></el-table-column>
            <el-table-column align="center" header-align="center" label="price" prop="price"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="sales volume"
            ...
            >
                <template slot-scope="scope">
                    <el-button
                        @click="addOrUpdateHandle(scope.row.skuId)"
                        size="small"
                        type="text"
                    >Update</el-button>
                    <el-button
