        ...
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button
                    ...
                    type="primary"
                    v-if="isAuth('commodity:spuinfodesc:save')"
                >Add</el-button>
                <el-button
                    :disabled="dataListSelections.length <= 0"
                    @click="deleteHandle()"
                    type="danger"
                    v-if="isAuth('commodity:spuinfodesc:delete')"
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <el-button
                        @click="addOrUpdateHandle(scope.row.spuId)"
                        size="small"
                        type="text"
                    >Update</el-button>
                    <el-button
                        @click="deleteHandle(scope.row.spuId)"
                        size="small"
                        type="text"
                    >Delete</el-button>
                </template>
