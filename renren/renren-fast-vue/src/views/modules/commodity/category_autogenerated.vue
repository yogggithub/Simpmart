<template>
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button
                    ...
                    type="primary"
                    v-if="isAuth('commodity:category:save')"
                >Add</el-button>
                <el-button
                    :disabled="dataListSelections.length <= 0"
                    @click="deleteHandle()"
                    type="danger"
                    v-if="isAuth('commodity:category:delete')"
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="category id" prop="catId"></el-table-column>
            <el-table-column align="center" header-align="center" label="category name" prop="name"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
