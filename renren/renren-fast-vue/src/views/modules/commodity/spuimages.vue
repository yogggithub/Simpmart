<template>
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button
                    ...
                    type="primary"
                    v-if="isAuth('commodity:spuimages:save')"
                >Add</el-button>
                <el-button
                    :disabled="dataListSelections.length <= 0"
                    @click="deleteHandle()"
                    type="danger"
                    v-if="isAuth('commodity:spuimages:delete')"
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="image name" prop="imgName"></el-table-column>
            <el-table-column align="center" header-align="center" label="image link" prop="imgUrl"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
            ...
            <el-table-column
                align="center"
                header-align="center"
                label="is default image [0->no, 1->yes]"
                prop="defaultImg"
            ></el-table-column>
            <el-table-column
                align="center"
    ...
    export default {
        ...
        methods: {
            ...
            getDataList () {
                ...
                this.$http({
                    url: this.$http.adornUrl('/commodity/spuimages/list'),
                    method: 'get',
            ...
            deleteHandle (id) {
                ...
                this.$confirm(`Do you want to [${id ? 'delete' : 'batch delete'}] [id=${ids.join(',')}]?`, 'warning', {
                    ...
                    this.$http({
                        url: this.$http.adornUrl('/commodity/spuimages/delete'),
                        method: 'post',
