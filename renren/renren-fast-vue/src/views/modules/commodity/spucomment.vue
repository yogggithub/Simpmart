<template>
    <div class="mod-config">
        <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
            ...
            <el-form-item>
                ...
                <el-button
                    ...
                    type="primary"
                    v-if="isAuth('commodity:spucomment:save')"
                >Add</el-button>
                <el-button
                    :disabled="dataListSelections.length <= 0"
                    @click="deleteHandle()"
                    type="danger"
                    v-if="isAuth('commodity:spucomment:delete')"
        ...
        >
            ...
            <el-table-column align="center" header-align="center" label="spu id" prop="spuId"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="product name"
            ...
            <el-table-column
                align="center"
                header-align="center"
                label="member nick name"
                prop="memberNickName"
            ></el-table-column>
            <el-table-column align="center" header-align="center" label="review rating" prop="star"></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="member ip address"
                prop="memberIp"
            ></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="review create time"
                prop="createTime"
            ></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="review showing status [0->no, 1->yes]"
                prop="showStatus"
            ></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="sku attributes combination when purchased"
                prop="spuAttributes"
            ></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="likes of the review"
                prop="likesCount"
            ></el-table-column>
            <el-table-column
                align="center"
                header-align="center"
                label="replies of the review"
                prop="replyCount"
            ></el-table-column>
            <el-table-column
                align="center"
    ...
    export default {
        ...
        methods: {
            ...
            getDataList () {
                ...
                this.$http({
                    url: this.$http.adornUrl('/commodity/spucomment/list'),
                    method: 'get',
            ...
            deleteHandle (id) {
                ...
                this.$confirm(`Do you want to [${id ? 'delete' : 'batch delete'}] [id=${ids.join(',')}]?`, 'warning', {
                    ...
                    this.$http({
                        url: this.$http.adornUrl('/commodity/spucomment/delete'),
                        method: 'post',
