    ...
    >
        ...
        >
            <el-form-item label="订单号（对外业务号）" prop="orderSn">
                <el-input placeholder="订单号（对外业务号）" v-model="dataForm.orderSn"></el-input>
            </el-form-item>
            <el-form-item label="订单id" prop="orderId">
                <el-input placeholder="订单id" v-model="dataForm.orderId"></el-input>
            </el-form-item>
            <el-form-item label="支付宝交易流水号" prop="alipayTradeNo">
                <el-input placeholder="支付宝交易流水号" v-model="dataForm.alipayTradeNo"></el-input>
            </el-form-item>
            <el-form-item label="支付总金额" prop="totalAmount">
                <el-input placeholder="支付总金额" v-model="dataForm.totalAmount"></el-input>
            </el-form-item>
            <el-form-item label="交易内容" prop="subject">
                <el-input placeholder="交易内容" v-model="dataForm.subject"></el-input>
            </el-form-item>
            <el-form-item label="支付状态" prop="paymentStatus">
                <el-input placeholder="支付状态" v-model="dataForm.paymentStatus"></el-input>
            </el-form-item>
            <el-form-item label="创建时间" prop="createTime">
                <el-input placeholder="创建时间" v-model="dataForm.createTime"></el-input>
            </el-form-item>
            <el-form-item label="确认时间" prop="confirmTime">
                <el-input placeholder="确认时间" v-model="dataForm.confirmTime"></el-input>
            </el-form-item>
            <el-form-item label="回调内容" prop="callbackContent">
                <el-input placeholder="回调内容" v-model="dataForm.callbackContent"></el-input>
            </el-form-item>
            <el-form-item label="回调时间" prop="callbackTime">
                <el-input placeholder="回调时间" v-model="dataForm.callbackTime"></el-input>
            </el-form-item>
        </el-form>
