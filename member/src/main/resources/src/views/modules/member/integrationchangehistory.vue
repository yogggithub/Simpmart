  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('member:integrationchangehistory:save')" type="primary" @click="addOrUpdateHandle()">Add</el-button>
        <el-button v-if="isAuth('member:integrationchangehistory:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="changd value (postive / negatvie)">
      </el-table-column>
      <el-table-column
        prop="note"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="point source [0 -> shopping, 1 -> manual addition, 2 -> promotion activity]">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
