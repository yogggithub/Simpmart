  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('member:membercollectsubject:save')" type="primary" @click="addOrUpdateHandle()">Add</el-button>
        <el-button v-if="isAuth('member:membercollectsubject:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="topic image link">
      </el-table-column>
      <el-table-column
        prop="subjectUrl"
        header-align="center"
        align="center"
        label="topic content link">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
