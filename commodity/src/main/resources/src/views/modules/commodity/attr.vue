  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('commodity:attr:save')" type="primary" @click="addOrUpdateHandle()">Add</el-button>
        <el-button v-if="isAuth('commodity:attr:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="need to search [0->no, 1->yes]">
      </el-table-column>
      <el-table-column
        prop="icon"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="List of available values, seperated by comma">
      </el-table-column>
      <el-table-column
        prop="attrType"
        header-align="center"
        align="center"
        label="attribute type [0->sales, 1->basic, 2->both]">
      </el-table-column>
      <el-table-column
        prop="enable"
        header-align="center"
        align="center"
        label="attribute status [0->disable, 1->enable]">
      </el-table-column>
      <el-table-column
        prop="catelogId"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="displayed on the product, can also be adjusted in spu [0->no, 1->yes]">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
