  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('commodity:attrattrgrouprelation:save')" type="primary" @click="addOrUpdateHandle()">Add</el-button>
        <el-button v-if="isAuth('commodity:attrattrgrouprelation:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="attribute grouping id">
      </el-table-column>
      <el-table-column
        prop="attrSort"
        header-align="center"
        align="center"
        label="attribute sequence">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        this.$http({
          url: this.$http.adornUrl('/commodity/attrattrgrouprelation/list'),
          method: 'get',
      ...
      deleteHandle (id) {
        ...
        this.$confirm(`Do you want to [${id ? 'delete' : 'batch delete'}] [id=${ids.join(',')}]?`, 'warning', {
          ...
          this.$http({
            url: this.$http.adornUrl('/commodity/attrattrgrouprelation/delete'),
            method: 'post',
