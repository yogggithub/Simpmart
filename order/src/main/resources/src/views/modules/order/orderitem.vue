  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('order:orderitem:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="bonus member rewards">
      </el-table-column>
      <el-table-column
        prop="giftGrowth"
        header-align="center"
        align="center"
        label="bonus growth points">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
