  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('order:orderreturnapply:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="return applicant name">
      </el-table-column>
      <el-table-column
        prop="returnPhone"
        header-align="center"
        align="center"
        label="return applicant phone number">
      </el-table-column>
      <el-table-column
        prop="status"
        header-align="center"
        align="center"
        label="application status[0->awaiting treatment, 1->Returning, 2->completed, 3->refused]">
      </el-table-column>
      <el-table-column
        prop="handleTime"
        header-align="center"
        align="center"
        label="application handle time">
      </el-table-column>
      <el-table-column
        prop="skuImg"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="sku attributes combination (JSON)">
      </el-table-column>
      <el-table-column
        prop="skuCount"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="grand total after deduction">
      </el-table-column>
      <el-table-column
        prop="reason"
        header-align="center"
