  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('order:ordersetting:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="lightning deal timeout (minutes)">
      </el-table-column>
      <el-table-column
        prop="normalOrderOvertime"
        header-align="center"
        align="center"
        label="regular timeout (minutes)">
      </el-table-column>
      <el-table-column
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="auto completion time, return window closed time (days)">
      </el-table-column>
      <el-table-column
        prop="commentOvertime"
        header-align="center"
        align="center"
        label="automatically review time after order completion (days)">
      </el-table-column>
      <el-table-column
        prop="memberLevel"
        header-align="center"
        align="center"
        label="required member level[0->unlimited, other->corresponding member level]">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
