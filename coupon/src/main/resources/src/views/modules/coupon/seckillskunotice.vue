  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:seckillskunotice:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="seckill section id">
      </el-table-column>
      <el-table-column
        prop="subcribeTime"
        header-align="center"
        align="center"
        label="member subcribe time">
      </el-table-column>
      <el-table-column
        prop="sendTime"
        header-align="center"
        align="center"
        label="subcribe notify time">
      </el-table-column>
      <el-table-column
        prop="noticeType"
        header-align="center"
        align="center"
        label="notify method [0->text, 1->email]">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
