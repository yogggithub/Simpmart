  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:skufullreduction:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="discount breakpoint amount">
      </el-table-column>
      <el-table-column
        prop="reducePrice"
        header-align="center"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="eligible for other offers [0->no, 1->yes]">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
