  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:seckillskurelation:save')" type="primary" @click="addOrUpdateHandle()">Add</el-button>
        <el-button v-if="isAuth('coupon:seckillskurelation:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="seckill activity id">
      </el-table-column>
      <el-table-column
        prop="promotionSessionId"
        header-align="center"
        align="center"
        label="seckill activity section id">
      </el-table-column>
      <el-table-column
        prop="skuId"
        header-align="center"
