  ...
  <div class="mod-config">
    <el-form :inline="true" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button v-if="isAuth('coupon:spubounds:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">Batch Deletion</el-button>
      </el-form-item>
    </el-form>
    <el-table
      :data="dataList"
      ...
      <el-table-column
        ...
        header-align="center"
        align="center"
        label="member shopping point">
      </el-table-column>
      <el-table-column
        prop="work"
        header-align="center"
        align="center"
        label="promotion status, 4 bits [from left to right, first->no discount, bonus growth point [0->no, 1->yes], second->no discount, bonus shopping point [0->no, 1->yes], third->discounted, bonus growth point [0->no, 1->yes], forth->discounted, bonus shopping point [0->no, 1->yes]">
      </el-table-column>
      <el-table-column
        fixed="right"
        header-align="center"
